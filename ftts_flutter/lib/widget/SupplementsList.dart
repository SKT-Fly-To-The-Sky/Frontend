...
import '../screen/SupplementsMainScreen.dart';

class SupplementsList extends StatefulWidget {
  @override
  _SupplementsListState createState() => _SupplementsListState();
}

class _SupplementsListState extends State<SupplementsList> {
  @override
  Widget build(BuildContext context) {
    List<String> supplementslist = [
      "힐링팩토리 블루마린 오메가3",
            ...
            return Container(
              child: Column(
                ...
                children: [
                  GestureDetector(
                      onTap: () {
                        print(supplementslist[i]);
                        String query=supplementslist[i];
                        showDialog(
                            context: context,
